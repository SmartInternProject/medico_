...
import './Bookappointment.module.css'; // Import the CSS file for styling
...
function AppointmentForm() {
  ...
  return (
    <div className={Style.container}>
      <h2 className={Style.heading}>Book an offline Appointment</h2>
      <form onSubmit={handleSubmit} className={Style.bookform}>
        ...
        <button type="submit" className={Style.formbutton}>Book Physical Appointment</button>
      </form>
    </div>
  );
}
